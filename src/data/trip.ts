...
export const trip: Trip = {
  ...
  // Grouped day by day. Each section is a stretch of the trip with its dates
  // and focus. Move places between sections / change day ranges freely.
  sections: [
    {
      id: 'd1', dayLabel: 'Day 1', dateLabel: 'Fri 21 Aug', title: 'Prague to Lake Garda',
      places: [
        { id: 'lake-garda', n: 1, name: 'Lake Garda', type: 'classic',
          blurb: 'Long drive down, lake arrival and scenic base.', coords: [45.65, 10.6833],
          about: 'Italy\'s largest lake, ringed by towns. Boat rides, swimming and easy walks.' },
      ],
    },
    {
      id: 'd2', dayLabel: 'Day 2', dateLabel: 'Sat 22 Aug', title: 'Lake Garda towns',
      places: [
        { id: 'peschiera', n: 2, name: 'Peschiera del Garda', type: 'instagram',
          blurb: 'Pretty lake-town base near Garda.', coords: [45.4392, 10.6889] },
        { id: 'bardolino', n: 3, name: 'Bardolino', type: 'instagram',
          blurb: 'Lakeside atmosphere and photo-friendly streets.', coords: [45.5494, 10.7206] },
        { id: 'sirmione', n: 4, name: 'Sirmione', type: 'instagram',
          blurb: 'Castle, harbour views, the most photogenic Garda town.', coords: [45.4969, 10.6058] },
        { id: 'castello-sirmione', n: 5, name: 'Castello Scaligero di Sirmione', type: 'instagram',
          blurb: 'Iconic moated castle by the lake.', coords: [45.4944, 10.6075] },
        { id: 'grotte-catullo', n: 6, name: 'Grotte di Catullo', type: 'instagram',
          blurb: 'Roman ruins at the tip of the peninsula.', coords: [45.5083, 10.6044] },
      ],
    },
    {
      id: 'd3', dayLabel: 'Day 3', dateLabel: 'Sun 23 Aug', title: 'Verona',
      places: [
        { id: 'verona', n: 7, name: 'Verona', type: 'classic',
          blurb: 'Historic centre, great for dinner and an evening out.', coords: [45.4384, 10.9916] },
        { id: 'piazza-erbe', n: 8, name: 'Piazza delle Erbe', type: 'classic',
          blurb: 'Verona\'s central square.', coords: [45.443, 10.9978] },
        { id: 'arena-verona', n: 9, name: 'Arena di Verona', type: 'classic',
          blurb: 'Roman amphitheatre and city landmark.', coords: [45.439, 10.9947] },
        { id: 'ponte-pietra', n: 10, name: 'Ponte Pietra', type: 'instagram',
          blurb: 'Romantic bridge photo spot.', coords: [45.447, 10.999] },
        { id: 'castel-san-pietro', n: 11, name: 'Castel San Pietro', type: 'instagram',
          blurb: 'Viewpoint over Verona.', coords: [45.448, 11.001] },
      ],
    },
    {
      id: 'd4', dayLabel: 'Day 4', dateLabel: 'Mon 24 Aug', title: 'Motor valley (Modena)',
      places: [
        { id: 'modena', n: 12, name: 'Modena', type: 'car',
          blurb: 'Base for the Ferrari / motor-valley day.', coords: [44.6471, 10.9252] },
        { id: 'enzo-ferrari', n: 13, name: 'Museo Enzo Ferrari (Modena)', type: 'car',
          blurb: 'Ferrari museum in Modena itself.', coords: [44.6516, 10.9265] },
        { id: 'ferrari-maranello', n: 14, name: 'Museo Ferrari Maranello', type: 'car',
          blurb: 'The Maranello museum, road and race cars plus a simulator.', coords: [44.5318, 10.8642] },
        { id: 'lamborghini', n: 15, name: 'Lamborghini Museum', type: 'car',
          blurb: 'Optional second motor-valley museum.', coords: [44.664, 11.13] },
      ],
    },
    {
      id: 'd5', dayLabel: 'Day 5', dateLabel: 'Tue 25 Aug', title: 'Florence',
      places: [
    ...
    {
      id: 'd6', dayLabel: 'Day 6', dateLabel: 'Wed 26 Aug', title: 'Chianti',
      places: [
    ...
    {
      id: 'd7', dayLabel: 'Day 7', dateLabel: 'Thu 27 Aug', title: 'Siena & San Gimignano',
      places: [
        { id: 'siena', n: 26, name: 'Siena', type: 'classic',
          blurb: 'Major Tuscan city.', coords: [43.3188, 11.3308] },
        { id: 'piazza-campo', n: 27, name: 'Piazza del Campo', type: 'instagram',
          blurb: 'Siena\'s main square, home of the Palio.', coords: [43.3186, 11.332] },
        { id: 'san-gimignano', n: 28, name: 'San Gimignano', type: 'instagram',
          blurb: 'Medieval hill town with towers.', coords: [43.4677, 11.0431] },
        { id: 'palazzo-comunale-sg', n: 29, name: 'Palazzo Comunale, Torre Grossa', type: 'classic',
          blurb: 'Tower and museum area in San Gimignano.', coords: [43.4677, 11.0436] },
      ],
    },
    {
      id: 'd8', dayLabel: 'Day 8', dateLabel: 'Fri 28 Aug', title: 'Tuscan coast',
      places: [
        { id: 'castiglione', n: 30, name: 'Castiglione della Pescaia', type: 'relaxed',
          blurb: 'Beach and sea-swim day on the Tuscan coast.', coords: [42.7639, 10.8769] },
      ],
    },
    {
      id: 'd9', dayLabel: 'Day 9', dateLabel: 'Sat 29 Aug', title: 'Lucca & Pisa',
      places: [
    ...
    {
      id: 'd10', dayLabel: 'Day 10', dateLabel: 'Sun 30 Aug', title: 'Drive home',
      places: [
        ...
        { id: 'prague', n: 36, name: 'Prague', type: 'endpoint',
          blurb: 'Home. Start and end of the road trip.', coords: [50.0755, 14.4378] },
      ],
    },
  ],
}
